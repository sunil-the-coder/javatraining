...
public class BookApplication {
	...
	public static void main(String[] args) {
		...
		/*
		 * book.setPrice(560); book.setBname("Effective Java in Nutshell");
		 * 
		 * bookDao.update(book);
		 * 
		 * System.out.println("----------- All Books ----------"); List<Book> books =
		 * bookDao.findAll(); for (Book b : books) System.out.println(b);
		 */
